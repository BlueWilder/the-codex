    ...
    <div className="min-h-screen pt-16 md:pt-24 flex flex-col text-foreground selection:bg-red-900/50 selection:text-white">
      ...
      <footer className="border-t border-amber-900/30 py-6 mt-8">
        <div className="container mx-auto px-4 text-center space-y-4">
          <p className="text-sm text-muted-foreground">Created by <a href="https://mageproductions.com" target="_blank" rel="noopener noreferrer" className="font-bold text-amber-600 hover:text-amber-500 underline">Mage Productions</a></p>
