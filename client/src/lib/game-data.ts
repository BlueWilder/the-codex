...
export const TRAVELLERS: Character[] = [
  ...
  { id: 'barista', name: 'Barista', edition: 'traveler', team: 'traveler', ability: 'Each night, until dusk, 1) a player becomes sober, healthy & gets true info, or 2) their ability works twice. The Storyteller chooses.', firstNightOrder: 9, otherNightOrder: 5, setup: false, reminders: ['Sober & Healthy', 'Acts Twice'], flavorQuote: '"Double shot?"', extendedSummary: 'Each night, Storyteller picks either: make one player sober and healthy with true info, OR make their ability work twice.', tipsAndTricks: ['Enhance player abilities', 'Cure drunk/poison or double power', 'Storyteller chooses effect'], bluffingAs: ['Traveller role'] },
...
export const JINXES: Jinx[] = [
  ...
  { character1: 'legion', character2: 'magician', reason: 'The Magician wakes with Legion and might register as evil. Legion knows if a Magician is in play, but not which player it is.' },
