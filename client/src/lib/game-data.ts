...
export const TRAVELLERS: Character[] = [
  ...
  { id: 'bureaucrat', name: 'Bureaucrat', edition: 'traveler', team: 'traveler', ability: 'Each night, choose a player (not yourself): their vote counts as 3 votes tomorrow.', firstNightOrder: 10, otherNightOrder: 6, setup: false, reminders: ['3 Votes'], flavorQuote: '"Please fill out form 27B stroke 6."', extendedSummary: 'Each night, choose a player. Their vote counts as 3 votes tomorrow, making them very influential in executions.', tipsAndTricks: ['Empower trusted players', 'Triple votes swing executions', 'Can help good or evil'], bluffingAs: ['Traveller'] },
  { id: 'thief', name: 'Thief', edition: 'traveler', team: 'traveler', ability: 'Each night, choose a player (not yourself): their vote counts negatively tomorrow.', firstNightOrder: 11, otherNightOrder: 7, setup: false, reminders: ['Negative Vote'], flavorQuote: '"What\'s yours is mine."', extendedSummary: 'Each night, choose a player. Their vote counts as -1 tomorrow, subtracting from vote totals instead of adding.', tipsAndTricks: ['Negate evil votes', 'Powerful vote manipulation', 'Negative votes reduce totals'], bluffingAs: ['Traveller ability'] },
  ...
  { id: 'deviant', name: 'Deviant', edition: 'traveler', team: 'traveler', ability: 'If you were funny today, you cannot die by exile.', firstNightOrder: null, otherNightOrder: null, setup: false, reminders: [], flavorQuote: '"Ha ha ha!"', extendedSummary: 'If you made people laugh today (Storyteller judges), you cannot be exiled. Humor protects you.', tipsAndTricks: ['Be entertaining to survive', 'Exile protection through comedy', 'Storyteller judges humor'], bluffingAs: ['Traveller role'] },
];
...
export const JINXES: Jinx[] = [
  { character1: 'alchemist', character2: 'boffin', reason: 'If the Alchemist has the Boffin ability, the Alchemist does not learn what ability the Demon has.' },
  { character1: 'alchemist', character2: 'marionette', reason: 'An Alchemist-Marionette has no Marionette ability & the Marionette is in play.' },
  { character1: 'alchemist', character2: 'organgrinder', reason: 'If the Alchemist has the Organ Grinder ability, the Organ Grinder is in play. If both are sober, both are drunk.' },
  { character1: 'alchemist', character2: 'spy', reason: 'An Alchemist-Spy has no Spy ability & a Spy is in play. After each execution, a living Alchemist-Spy may publicly guess a living player as the Spy. If correct, the Demon must choose the Spy tonight.' },
  { character1: 'alchemist', character2: 'summoner', reason: 'The Alchemist-Summoner does not get bluffs, and chooses which Demon but not which player. If they die before this happens, evil wins. [No Demon]' },
  { character1: 'alchemist', character2: 'widow', reason: 'An Alchemist-Widow has no Widow ability & a Widow is in play. After each execution, a living Alchemist-Widow may publicly guess a living player as the Widow. If correct, the Demon must choose the Widow tonight.' },
  { character1: 'alchemist', character2: 'wraith', reason: 'An Alchemist-Wraith has no Wraith ability & a Wraith is in play. After each execution, a living Alchemist-Wraith may publicly guess a living player as the Wraith. If correct, the Demon must choose the Wraith tonight.' },
  { character1: 'alhadikhia', character2: 'princess', reason: 'If the Princess nominated & executed a player on their 1st day, no one dies to the Al-Hadikhia tonight.' },
  { character1: 'alhadikhia', character2: 'scarletwoman', reason: 'If there would be two Demons, one of which was the Scarlet Woman, the Scarlet Woman becomes the Scarlet Woman again.' },
  { character1: 'alsaahir', character2: 'vizier', reason: 'The Storyteller doesn\'t declare the Vizier is in play.' },
  { character1: 'atheist', character2: 'riot', reason: 'During a riot, if the Storyteller is nominated, players vote. If they are "about to die", the game ends. If not, they nominate again.' },
  { character1: 'balloonist', character2: 'marionette', reason: 'If the Marionette thinks that they are the Balloonist, an Outsider might have been added during setup.' },
  { character1: 'banshee', character2: 'leviathan', reason: 'Each night*, the Leviathan chooses an alive good player (different to previous nights): a chosen Banshee dies & gains their ability.' },
  { character1: 'banshee', character2: 'riot', reason: 'Each night*, Riot chooses an alive good player (different to previous nights): a chosen Banshee dies & gains their ability.' },
  { character1: 'banshee', character2: 'vortox', reason: 'If the Vortox kills the Banshee, all players learn that the Banshee has died.' },
  { character1: 'baron', character2: 'heretic', reason: 'Only 1 jinxed character can be in play.' },
  { character1: 'baron', character2: 'plaguedoctor', reason: 'If the Storyteller would gain the Baron ability, up to two players become Outsiders.' },
  { character1: 'boffin', character2: 'cultleader', reason: 'If the Demon has the Cult Leader ability, they can\'t turn good due to this ability.' },
  { character1: 'boffin', character2: 'drunk', reason: 'The Demon cannot have the Drunk ability.' },
  { character1: 'boffin', character2: 'heretic', reason: 'The Demon cannot have the Heretic ability.' },
  { character1: 'boffin', character2: 'ogre', reason: 'The Demon cannot have the Ogre ability.' },
  { character1: 'boffin', character2: 'politician', reason: 'The Demon cannot have the Politician ability.' },
  { character1: 'boffin', character2: 'villageidiot', reason: 'If there is a spare token, the Boffin can give the Demon the Village Idiot ability.' },
  { character1: 'boomdandy', character2: 'plaguedoctor', reason: 'If the Storyteller would gain the Boomdandy ability, a player becomes the Boomdandy.' },
  { character1: 'bountyhunter', character2: 'kazali', reason: 'If the Kazali turns the Bounty Hunter into a Minion, an evil Townsfolk is not created.' },
  { character1: 'butler', character2: 'cannibal', reason: 'If the Cannibal gains the Butler ability, the Cannibal learns this.' },
  { character1: 'butler', character2: 'organgrinder', reason: 'If the Organ Grinder is causing eyes closed voting, the Butler may raise their hand to vote but their vote is only counted if their master voted too.' },
  { character1: 'cannibal', character2: 'princess', reason: 'If the Cannibal nominated, executed, & killed the Princess today, the Demon doesn\'t kill tonight.' },
  { character1: 'cannibal', character2: 'zealot', reason: 'If the Cannibal gains the Zealot ability, the Cannibal learns this.' },
  { character1: 'damsel', character2: 'spy', reason: 'If the Spy is (or has been) in play, the Damsel is poisoned.' },
  { character1: 'damsel', character2: 'widow', reason: 'If the Widow is (or has been) in play, the Damsel is poisoned.' },
  { character1: 'engineer', character2: 'legion', reason: 'If Legion is created, all evil players become Legion. If Legion is in play, the Engineer starts knowing this but has no ability.' },
  { character1: 'engineer', character2: 'summoner', reason: 'If the living Summoner is removed from play, the Storyteller has the Summoner ability.' },
  { character1: 'fangGu', character2: 'scarletwoman', reason: 'If there would be two Demons, one of which was the Scarlet Woman, the Scarlet Woman remains the Scarlet Woman.' },
  { character1: 'farmer', character2: 'leviathan', reason: 'Each night*, the Leviathan chooses an alive good player (different to previous nights): a chosen Farmer uses their ability but does not die.' },
  { character1: 'farmer', character2: 'riot', reason: 'Each night*, Riot chooses an alive good player (different to previous nights): a chosen Farmer uses their ability but does not die.' },
  { character1: 'fearmonger', character2: 'plaguedoctor', reason: 'If the Storyteller would gain the Fearmonger ability, a Minion gains it, and learns this.' },
  { character1: 'fearmonger', character2: 'vizier', reason: 'The Vizier wakes with the Fearmonger, learns who they choose and cannot choose to immediately execute that player.' },
  { character1: 'goblin', character2: 'plaguedoctor', reason: 'If the Storyteller would gain the Goblin ability, a Minion gains it, and learns this.' },
  { character1: 'grandmother', character2: 'leviathan', reason: 'If the Leviathan is in play and the Grandchild dies by execution, evil wins.' },
  { character1: 'grandmother', character2: 'riot', reason: 'If Riot is in play and the Grandchild dies by execution, evil wins.' },
  { character1: 'hatter', character2: 'legion', reason: 'If Legion is created, all evil players become Legion. If Legion is in play, the Hatter has no ability.' },
  { character1: 'hatter', character2: 'leviathan', reason: 'The Leviathan cannot enter play after day 5.' },
  { character1: 'hatter', character2: 'lilmonsta', reason: 'If the Hatter dies & the Demon chooses Lil\' Monsta, they also choose a Minion to become.' },
  { character1: 'hatter', character2: 'summoner', reason: 'If the Summoner creates a second living Demon, deaths tonight are arbitrary.' },
  { character1: 'heretic', character2: 'lleech', reason: 'Only 1 jinxed character can be in play.' },
  { character1: 'heretic', character2: 'spy', reason: 'Only 1 jinxed character can be in play.' },
  { character1: 'heretic', character2: 'widow', reason: 'Only 1 jinxed character can be in play.' },
  { character1: 'huntsman', character2: 'marionette', reason: 'If the Marionette thinks that they are the Huntsman, the Damsel was added during setup.' },
  { character1: 'investigator', character2: 'vizier', reason: 'The Storyteller doesn\'t declare the Vizier is in play.' },
  { character1: 'kazali', character2: 'marionette', reason: 'If there would be a Marionette in play, they enter play after the Demon & must start as their neighbor.' },
  { character1: 'kazali', character2: 'summoner', reason: 'If the Summoner creates a second living Demon, deaths tonight are arbitrary.' },
  { character1: 'king', character2: 'leviathan', reason: 'If the Leviathan is in play, and at least 1 player is dead, the King learns an alive character each night.' },
  { character1: 'king', character2: 'riot', reason: 'If Riot is in play, and at least 1 player is dead, the King learns an alive character each night.' },
  { character1: 'legion', character2: 'magician', reason: 'If the Magician is in play, during the Demon info step, Legion wake in separate groups. Each group learns which players are good, but does not learn the Magician.' },
  { character1: 'legion', character2: 'politician', reason: 'The Politician might register as evil to Legion.' },
  { character1: 'legion', character2: 'preacher', reason: 'If the Preacher chooses Legion, Legion keeps their ability, but the Preacher might learn they are Legion.' },
  { character1: 'legion', character2: 'summoner', reason: 'If Legion is summoned, all evil players become Legion.' },
  { character1: 'legion', character2: 'zealot', reason: 'The Zealot might register as evil to Legion.' },
  { character1: 'leviathan', character2: 'mayor', reason: 'If the Leviathan and the Mayor are alive on day 5 & no execution occurs, good wins.' },
  { character1: 'leviathan', character2: 'monk', reason: 'If the Leviathan nominates and executes the Monk-protected player, good wins.' },
  { character1: 'leviathan', character2: 'ravenkeeper', reason: 'Each night*, the Leviathan chooses an alive player (different to previous nights): a chosen Ravenkeeper uses their ability but does not die.' },
  { character1: 'leviathan', character2: 'soldier', reason: 'If the Leviathan nominates and executes the Soldier, good wins.' },
  { character1: 'lilmonsta', character2: 'magician', reason: 'If the Magician is alive, the Storyteller chooses which Minion babysits Lil\' Monsta.' },
  { character1: 'lilmonsta', character2: 'marionette', reason: 'If there would be a Marionette in play, they enter play after the Demon & must start as their neighbor.' },
  { character1: 'lilmonsta', character2: 'poppygrower', reason: 'If Lil\' Monsta & the Poppy Grower are alive, Minions wake one by one, until one of them chooses to take the Lil\' Monsta token.' },
  { character1: 'lilmonsta', character2: 'psychopath', reason: 'If the Psychopath is babysitting Lil\' Monsta, they die when executed.' },
  { character1: 'lilmonsta', character2: 'scarletwoman', reason: 'If Lil\' Monsta dies with 5 or more players alive, the Scarlet Woman babysits Lil\' Monsta for the rest of the game.' },
  { character1: 'lilmonsta', character2: 'vizier', reason: 'If the Vizier is babysitting Lil\' Monsta, they die when executed.' },
  { character1: 'lleech', character2: 'slayer', reason: 'If the Slayer slays the Lleech host, the host dies.' },
  { character1: 'lordoftyphon', character2: 'summoner', reason: 'If a Lord of Typhon is summoned, they must neighbor a Minion & their other neighbor becomes an evil Minion.' },
  { character1: 'magician', character2: 'marionette', reason: 'If the Magician is alive, the Demon doesn\'t know which neighbor is the Marionette.' },
  { character1: 'magician', character2: 'spy', reason: 'When the Spy sees the Grimoire, the Demon and Magician\'s character tokens are removed.' },
  { character1: 'magician', character2: 'vizier', reason: 'If the Vizier is in play, the Magician has no ability but is immune to the Vizier\'s ability.' },
  { character1: 'magician', character2: 'widow', reason: 'When the Widow sees the Grimoire, the Demon and Magician\'s character tokens are removed.' },
  { character1: 'magician', character2: 'wraith', reason: 'After each execution, the living Magician may publicly guess a living player as the Wraith. If correct, the Demon must choose the Wraith tonight.' },
  { character1: 'marionette', character2: 'plaguedoctor', reason: 'If the Storyteller would gain the Marionette ability, one of the Demon\'s good neighbors becomes the Marionette.' },
  { character1: 'marionette', character2: 'summoner', reason: 'If there would be a Marionette in play, they enter play after the Demon & must start as their neighbor.' },
  { character1: 'mayor', character2: 'riot', reason: 'The Mayor may choose to stop the riot. If they do so when only 1 Riot is alive, good wins. Otherwise, evil wins.' },
  { character1: 'monk', character2: 'riot', reason: 'If Riot nominates and executes the Monk-protected player, good wins.' },
  { character1: 'ogre', character2: 'recluse', reason: 'If the Recluse registers as evil to the Ogre, the Ogre learns that they are evil.' },
  { character1: 'ogre', character2: 'spy', reason: 'The Spy registers as evil to the Ogre.' },
  { character1: 'plaguedoctor', character2: 'scarletwoman', reason: 'If the Storyteller would gain the Scarlet Woman ability, a Minion gains it, and learns this.' },
  { character1: 'plaguedoctor', character2: 'spy', reason: 'If the Storyteller would gain the Spy ability, a Minion gains it, and learns this.' },
  { character1: 'plaguedoctor', character2: 'wraith', reason: 'If the Storyteller would gain the Wraith ability, a Minion gains it, and learns this.' },
  { character1: 'politician', character2: 'vizier', reason: 'The Politician might register as evil to the Vizier.' },
  { character1: 'poppygrower', character2: 'spy', reason: 'If the Poppy Grower has their ability, the Spy does not see the Grimoire.' },
  { character1: 'poppygrower', character2: 'summoner', reason: 'If the Poppy Grower is alive on the 3rd night, the Summoner chooses which Demon but not which player.' },
  { character1: 'poppygrower', character2: 'widow', reason: 'If the Poppy Grower has their ability, the Widow does not see the Grimoire.' },
  { character1: 'preacher', character2: 'summoner', reason: 'If the living Summoner has no ability, the Storyteller has the Summoner ability.' },
  { character1: 'preacher', character2: 'vizier', reason: 'If the Vizier loses their ability, they learn this, and cannot die during the day.' },
  { character1: 'pukka', character2: 'summoner', reason: 'The Summoner may summon a Pukka on the 2nd night instead of the 3rd.' },
  { character1: 'ravenkeeper', character2: 'riot', reason: 'Each night*, Riot chooses an alive good player (different to previous nights): a chosen Ravenkeeper uses their ability but does not die.' },
  { character1: 'riot', character2: 'soldier', reason: 'If Riot nominates and executes the Soldier, good wins.' },
  { character1: 'summoner', character2: 'zombuul', reason: 'If the Summoner summons a dead player into the Zombuul, the Zombuul has already "died once".' },
  { character1: 'vizier', character2: 'zealot', reason: 'The Zealot might register as evil to the Vizier.' },
  { character1: 'alchemist', character2: 'mastermind', reason: 'An Alchemist-Mastermind has no Mastermind ability & the Mastermind is not-in-play.' },
  { character1: 'alhadikhia', character2: 'mastermind', reason: 'If the Al-Hadikhia dies by execution, and the Mastermind is alive, the Al-Hadikhia chooses 3 good players tonight: if all 3 choose to live, evil wins. Otherwise, good wins.' },
  { character1: 'boffin', character2: 'goon', reason: 'If the Demon has the Goon ability, they can\'t turn good due to this ability.' },
  { character1: 'bountyhunter', character2: 'philosopher', reason: 'If the Philosopher gains the Bounty Hunter ability, a Townsfolk might turn evil.' },
  { character1: 'cannibal', character2: 'juggler', reason: 'If the Juggler guesses on their first day and dies by execution, tonight the living Cannibal learns how many guesses the Juggler got correct.' },
  { character1: 'cerenovus', character2: 'goblin', reason: 'The Cerenovus may choose to make a player mad that they are the Goblin.' },
  { character1: 'godfather', character2: 'heretic', reason: 'Only 1 jinxed character can be in play.' },
  { character1: 'heretic', character2: 'pitHag', reason: 'Only 1 jinxed character can be in play.' },
  { character1: 'legion', character2: 'minstrel', reason: 'If Legion died by execution today, Legion keeps their ability, but the Minstrel might learn they are Legion.' },
  { character1: 'exorcist', character2: 'leviathan', reason: 'If the Leviathan nominates and executes the Exorcist-chosen player, good wins.' },
  { character1: 'innkeeper', character2: 'leviathan', reason: 'If the Leviathan nominates and executes an Innkeeper-protected player, good wins.' },
  { character1: 'leviathan', character2: 'pitHag', reason: 'The Leviathan cannot enter play after day 5.' },
  { character1: 'leviathan', character2: 'sage', reason: 'Each night*, the Leviathan chooses an alive good player (different to previous nights): a chosen Sage uses their ability but does not die.' },
  { character1: 'lleech', character2: 'mastermind', reason: 'If the Mastermind is alive and the Lleech host dies by execution, the Lleech lives but loses their ability.' },
  { character1: 'mastermind', character2: 'vigormortis', reason: 'A Mastermind that has their ability keeps it if the Vigormortis dies.' },
  { character1: 'chambermaid', character2: 'mathematician', reason: 'The Chambermaid can detect if the Mathematician will wake tonight.' },
  { character1: 'drunk', character2: 'mathematician', reason: 'The Mathematician learns if the Drunk\'s ability yielded false info or failed to work properly.' },
  { character1: 'lunatic', character2: 'mathematician', reason: 'The Mathematician learns if the Lunatic attacks a different player than the real Demon attacked.' },
  { character1: 'marionette', character2: 'mathematician', reason: 'The Mathematician learns if the Marionette\'s ability yielded false info or failed to work properly.' },
  { character1: 'cultleader', character2: 'pitHag', reason: 'If the Pit-Hag turns an evil player into the Cult Leader, they can\'t turn good due to their own ability.' },
  { character1: 'damsel', character2: 'pitHag', reason: 'If a Pit-Hag creates a Damsel, the Storyteller chooses which player it is.' },
  { character1: 'goon', character2: 'pitHag', reason: 'If the Pit-Hag turns an evil player into the Goon, they can\'t turn good due to their own ability.' },
  { character1: 'ogre', character2: 'pitHag', reason: 'If the Pit-Hag turns an evil player into the Ogre, they can\'t turn good due to their own ability.' },
  { character1: 'pitHag', character2: 'politician', reason: 'If the Pit-Hag turns an evil player into the Politician, they can\'t turn good due to their own ability.' },
  { character1: 'pitHag', character2: 'villageidiot', reason: 'If there is a spare token, the Pit-Hag can create an extra Village Idiot. If so, the drunk Village Idiot might change.' },
  { character1: 'evilTwin', character2: 'plaguedoctor', reason: 'If the Storyteller would gain the Evil Twin ability, a player becomes the Evil Twin.' },
  { character1: 'recluse', character2: 'sage', reason: 'The Recluse might register as the Demon to the Sage.' },
  { character1: 'exorcist', character2: 'riot', reason: 'If Riot nominates and executes the Exorcist-chosen player, good wins.' },
  { character1: 'innkeeper', character2: 'riot', reason: 'If Riot nominates and executes an Innkeeper-protected player, good wins.' },
  { character1: 'riot', character2: 'sage', reason: 'Each night*, Riot chooses an alive good player (different to previous nights): a chosen Sage uses their ability but does not die.' },
  { character1: 'clockmaker', character2: 'summoner', reason: 'The Summoner registers as the Demon to the Clockmaker.' },
  { character1: 'courtier', character2: 'summoner', reason: 'If the living Summoner has no ability, the Storyteller has the Summoner ability.' },
  { character1: 'pitHag', character2: 'summoner', reason: 'If the Summoner creates a second living Demon, deaths tonight are arbitrary.' },
  { character1: 'courtier', character2: 'vizier', reason: 'If the Vizier loses their ability, they learn this, and cannot die during the day.' },
  { character1: 'exorcist', character2: 'yaggababble', reason: 'If the Exorcist chooses the Yaggababble, the Yaggababble does not kill tonight.' },
];
// ===================
...
export const OFFICIAL_SCRIPTS = [
  {
    ...
    synopsis: 'Clouds roll in over Ravenswood Bluff, engulfing this sleepy town and its superstitious inhabitants in foreboding shadow. Freshly-washed clothes dance eerily on lines strung between cottages. Chimneys cough plumes of smoke into the air. Exotic scents waft through cracks in windows and under doors, as hidden cauldrons lay bubbling.\n\nAn unusually warm Autumn breeze wraps around vine-covered walls and whispers ominously to those brave enough to walk the cobbled streets. Anxious mothers call their children home from play, as thunder begins to clap on the horizon. If you listen more closely, however, noises stranger still can be heard echoing from the neighbouring forest. Under the watchful eye of a looming monastery, silhouetted figures skip from doorway to doorway. Those who can read the signs know there is... Trouble Brewing.',
  },
  {
    id: 'bmr',
    ...
    synopsis: 'The sun is swallowed by a jagged horizon as another winter\'s day surrenders to the night. Flecks of orange and red decay into deeper browns, the forest transforming in silent anticipation of the coming snow. Ravenous wolves howl from the bowels of a rocky crevasse beyond the town borders, sending birds scattering from their cozy rooks.\n\nTravellers hurry into the inn, seeking shelter from the gathering chill. They warm themselves with hot tea, sweet strains of music and hearty ale, unaware that strange and nefarious eyes stalk them from the ruins of this once great city. Tonight, even the livestock know there is a... Bad Moon Rising.',
  },
  {
    id: 'snv',
    name: 'Sects & Violets',
  ...
  },
  {
    ...
    isOfficial: false,
    characters: ['bountyhunter', 'balloonist', 'preacher', 'snakecharmer', 'undertaker', 'monk', 'savant', 'professor', 'alchemist', 'cannibal', 'virgin', 'magician', 'ogre', 'drunk', 'golem', 'barber', 'witch', 'pitHag', 'wizard', 'summoner', 'boffin', 'imp', 'kazali', 'po', 'vigormortis', 'cacklejack', 'matron', 'gangster', 'bonecollector', 'apprentice', 'gnome'],
  },
  {
    id: 'la',
