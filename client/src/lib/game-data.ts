...
export const JINXES: Jinx[] = [
  { character1: 'heretic', character2: 'baron', reason: 'Only 1 jinxed character can be in play.' },
  { character1: 'heretic', character2: 'boffin', reason: 'The Demon cannot have the Heretic ability.' },
  ...
  { character1: 'magician', character2: 'legion', reason: 'The Magician wakes with Legion and might register as evil. Legion knows if a Magician is in play, but not which player it is.' },
  { character1: 'magician', character2: 'lilmonsta', reason: 'If the Magician is alive, the Storyteller chooses which Minion babysits Lil\' Monsta.' },
  ...
  { character1: 'poppygrower', character2: 'lilmonsta', reason: 'If Lil\' Monsta & the Poppy Grower are alive, Minions wake one by one, until one of them chooses to take the Lil\' Monsta token.' },
  ...
  { character1: 'recluse', character2: 'ogre', reason: 'If the Recluse registers as evil to the Ogre, the Ogre learns that they are evil.' },
  { character1: 'plaguedoctor', character2: 'baron', reason: 'If the Storyteller would gain the Baron ability, up to two players become Outsiders.' },
  { character1: 'plaguedoctor', character2: 'boomdandy', reason: 'If the Storyteller would gain the Boomdandy ability, a player becomes the Boomdandy.' },
  { character1: 'plaguedoctor', character2: 'fearmonger', reason: 'If the Storyteller would gain the Fearmonger ability, a Minion gains it, and learns this.' },
  { character1: 'plaguedoctor', character2: 'goblin', reason: 'If the Storyteller would gain the Goblin ability, a Minion gains it, and learns this.' },
  { character1: 'plaguedoctor', character2: 'marionette', reason: 'If the Storyteller would gain the Marionette ability, one of the Demon\'s good neighbors becomes the Marionette.' },
  ...
  { character1: 'cannibal', character2: 'butler', reason: 'If the Cannibal gains the Butler ability, the Cannibal learns this.' },
  ...
  { character1: 'legion', character2: 'engineer', reason: 'If Legion is created, all evil players become Legion. If Legion is in play, the Engineer starts knowing this but has no ability.' },
  { character1: 'legion', character2: 'hatter', reason: 'If Legion is created, all evil players become Legion. If Legion is in play, the Hatter has no ability.' },
  ...
  { character1: 'riot', character2: 'atheist', reason: 'During a riot, if the Storyteller is nominated, players vote. If they are "about to die", the game ends. If not, they nominate again.' },
  { character1: 'riot', character2: 'banshee', reason: 'Each night*, Riot chooses an alive good player (different to previous nights): a chosen Banshee dies & gains their ability.' },
  { character1: 'riot', character2: 'farmer', reason: 'Each night*, Riot chooses an alive good player (different to previous nights): a chosen Farmer uses their ability but does not die.' },
  { character1: 'riot', character2: 'grandmother', reason: 'If Riot is in play and the Grandchild dies by execution, evil wins.' },
  { character1: 'riot', character2: 'king', reason: 'If Riot is in play, and at least 1 player is dead, the King learns an alive character each night.' },
  { character1: 'riot', character2: 'mayor', reason: 'The Mayor may choose to stop the riot. If they do so when only 1 Riot is alive, good wins. Otherwise, evil wins.' },
  { character1: 'riot', character2: 'monk', reason: 'If Riot nominates and executes the Monk-protected player, good wins.' },
  { character1: 'riot', character2: 'ravenkeeper', reason: 'Each night*, Riot chooses an alive good player (different to previous nights): a chosen Ravenkeeper uses their ability but does not die.' },
  { character1: 'riot', character2: 'soldier', reason: 'If Riot nominates and executes the Soldier, good wins.' },
  { character1: 'lilmonsta', character2: 'hatter', reason: 'If the Hatter dies & the Demon chooses Lil\' Monsta, they also choose a Minion to become.' },
  ...
  { character1: 'leviathan', character2: 'banshee', reason: 'Each night*, the Leviathan chooses an alive good player (different to previous nights): a chosen Banshee dies & gains their ability.' },
  { character1: 'leviathan', character2: 'farmer', reason: 'Each night*, the Leviathan chooses an alive good player (different to previous nights): a chosen Farmer uses their ability but does not die.' },
  { character1: 'leviathan', character2: 'grandmother', reason: 'If the Leviathan is in play and the Grandchild dies by execution, evil wins.' },
  { character1: 'leviathan', character2: 'hatter', reason: 'The Leviathan cannot enter play after day 5.' },
  { character1: 'leviathan', character2: 'king', reason: 'If the Leviathan is in play, and at least 1 player is dead, the King learns an alive character each night.' },
  ...
  { character1: 'kazali', character2: 'bountyhunter', reason: 'If the Kazali turns the Bounty Hunter into a Minion, an evil Townsfolk is not created.' },
  ...
  { character1: 'summoner', character2: 'pukka', reason: 'The Summoner may summon a Pukka on the 2nd night instead of the 3rd.' },
  ...
  { character1: 'summoner', character2: 'marionette', reason: 'If there would be a Marionette in play, they enter play after the Demon & must start as their neighbor.' },
  { character1: 'summoner', character2: 'preacher', reason: 'If the living Summoner is removed from play, the Storyteller has the Summoner ability.' },
  ...
  { character1: 'organgrinder', character2: 'butler', reason: 'If the Organ Grinder is causing eyes closed voting, the Butler may raise their hand to vote but their vote is only counted if their master voted too.' },
  { character1: 'vizier', character2: 'alsaahir', reason: 'The Storyteller doesn\'t declare the Vizier is in play.' },
  { character1: 'vizier', character2: 'fearmonger', reason: 'The Vizier wakes with the Fearmonger, learns who they choose and cannot choose to immediately execute that player.' },
  { character1: 'vizier', character2: 'politician', reason: 'The Politician might register as evil to the Vizier.' },
  { character1: 'vizier', character2: 'preacher', reason: 'If the Vizier loses their ability, they learn this, and cannot die during the day.' },
  { character1: 'vizier', character2: 'zealot', reason: 'The Zealot might register as evil to the Vizier.' },
  { character1: 'marionette', character2: 'balloonist', reason: 'If the Marionette thinks that they are the Balloonist, an Outsider might have been added during setup.' },
  { character1: 'marionette', character2: 'huntsman', reason: 'If the Marionette thinks that they are the Huntsman, the Damsel was added during setup.' },
  { character1: 'scarletwoman', character2: 'alhadikhia', reason: 'If there would be two Demons, one of which was the Scarlet Woman, the Scarlet Woman becomes the Scarlet Woman again.' },
  { character1: 'scarletwoman', character2: 'fangGu', reason: 'If there would be two Demons, one of which was the Scarlet Woman, the Scarlet Woman remains the Scarlet Woman.' },
  { character1: 'princess', character2: 'alhadikhia', reason: 'If the Princess nominated & executed a player on their 1st day, no one dies to the Al-Hadikhia tonight.' },
  { character1: 'vortox', character2: 'banshee', reason: 'If the Vortox kills the Banshee, all players learn that the Banshee has died.' },
  ...
  { character1: 'summoner', character2: 'engineer', reason: 'If the living Summoner is removed from play, the Storyteller has the Summoner ability.' },
  { character1: 'summoner', character2: 'hatter', reason: 'If the Summoner creates a second living Demon, deaths tonight are arbitrary.' },
  { character1: 'summoner', character2: 'kazali', reason: 'If the Summoner creates a second living Demon, deaths tonight are arbitrary.' },
